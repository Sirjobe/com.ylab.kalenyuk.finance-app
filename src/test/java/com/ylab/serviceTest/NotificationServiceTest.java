...
public class NotificationServiceTest {
    ...
    @Test
    void testCheckBudgetsAndNotify() throws SQLException {
    ...
    @Test
    void testCheckGoalsAndNotify() throws SQLException {
    ...
    void testNoNotifications() throws SQLException {
        ...
        System.out.println(budgetNotifications.stream().toList());
        System.out.println(goalNotifications.stream().toList());
